...
1. Build or download `Windows-Essentials-0.16.1.streamDeckPlugin`.
...
Version 0.16.1 is the visual refinement release with playback-state polling and application-PID recovery. The next major work is testing on more hardware and preparing an OpenDeck marketplace submission. A separate Codex integration can be added later without changing the reliable system-volume path.
